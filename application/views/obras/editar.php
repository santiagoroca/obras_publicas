<div class="page-header page-header-custom" >
	<h1 class="update-user-title" >Editar Obra</h1>
</div>
<form method="POST" action="<?=$action_url?>">
	...
	<div class="form-group">
		<textarea class="form-control avoidresize" rows="3" placeholder="Descripción Detallada"></textarea>
		<div class="form-group">
			<label class="log-in">Cambia la foto de la Obra.</label>
...
<span class="label label-danger">En tiempo y forma</span>
	...
	<button type="submit" class="btn btn-success row col-md-offset-10 log-in">Guardar cambios</button>
</form>