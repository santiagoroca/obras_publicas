      ...
      <form method="POST" action="">
        <div class="col-md-5">
          ...
          <div class="form-group">
            ...
            <input name="fechadenacimiento" class="form-control" placeholder="Fecha de Nacimiento" required>
          </div>
          <div class="form-group">
        ...
        <div class="col-md-5">
          <div class="form-group">
            ...
            <input name="apellido" type="password" class="form-control" placeholder="Apellido" required>
          </div>
          <div class="form-group">
